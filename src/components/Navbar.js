...
const Navbar = (props) => {
  ...
  return (
    <div className='m'>
       ...
       {/* <p className='logo'>Lorem</p> */}
        ...
        {/* <div> */}
            ...
            <ul className={menuBtn?('list show'):('list')}>
                ...
                <li className='cartIcon' onClick={cartHandler}><BsCart3/><span class="badge">{cartItems.length}</span></li>
     ...
     <div className={cartBtn?('sidebar showSidebar'):('sidebar')}><Cart cartItems={cartItems} setCartItems={setCartItems} cartBtn={cartBtn} setCartBtn={setCartBtn}/></div>
    </div>
  )
}
